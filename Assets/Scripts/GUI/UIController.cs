...
public class UIController : MonoBehaviour
{
    ...
    #region Methods
    /// <summary>
    /// Sets the DroneController from which to get the data from to be displayed.
    /// </summary>
    /// <param name="target">The DroneController to display the data of.</param>
    ...
    {
        return simulationUI.CanSaveBestGenotype();
    }
    #endregion
}
